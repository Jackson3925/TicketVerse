...
contract TestingTokenURI is Test {
    ...
    function testTokenURIBasicStructure() public {
        ...
        address ticketContract =
            factory.createEvent("Summer Fest", "FEST", block.timestamp + 1 days, organizer, ticketTypes);
        ...
        assertTrue(
            contains(json, '"image":"https://gateway.pinata.cloud/ipfs/QmVIPticket"'), "Should contain image URL"
        );
    ...
    function testTokenURIAttributes() public {
        ...
        vm.prank(owner);
        address ticketContract =
            factory.createEvent("Music Festival", "MUSIC", block.timestamp + 2 days, organizer, ticketTypes);
    ...
    function testTokenURIForNonExistentToken() public {
        ...
        vm.prank(owner);
        address ticketContract =
            factory.createEvent("Test Event", "TEST", block.timestamp + 1 days, organizer, ticketTypes);
    ...
    function testTokenURIJSONValidStructure() public {
        ...
        vm.prank(owner);
        address ticketContract =
            factory.createEvent("Concert 2024", "CON24", block.timestamp + 3 days, organizer, ticketTypes);
    ...
    function testMultipleEventsTokenURI() public {
        ...
        vm.prank(owner);
        address ticketContract1 =
            factory.createEvent("Event One", "E1", block.timestamp + 1 days, organizer, ticketTypes1);
        ...
        vm.prank(owner);
        address ticketContract2 =
            factory.createEvent("Event Two", "E2", block.timestamp + 2 days, organizer, ticketTypes2);
