...
contract TicketFactory is Ownable {
    ...
    //     // Mint ticket WITHOUT forwarding value (payment handled in factory)
    //     tokenId = ticketContract.mintTicket(ticketTypeId, recipient);
        
    //     // Transfer payment to organizer
    //     (bool paymentSent, ) = e.organizer.call{value: ticketPrice}("");
    //     require(paymentSent, "Payment transfer failed");
        
    //     // Refund any excess payment
    //     if (msg.value > ticketPrice) {
    //         (paymentSent, ) = msg.sender.call{value: msg.value - ticketPrice}("");
    //         require(paymentSent, "Refund failed");
    //     }
